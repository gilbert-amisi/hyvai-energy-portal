...
export default function HomeGridModal({ system, onClose }: { system: any, onClose: () => void }) {
  if (!system) return null;

  const imageUrl = system.Picture?.url ? `http://127.0.0.1:1337${system.Picture.url}` : null;
  const datasheetUrl = system.Catalog?.url ? `http://127.0.0.1:1337${system.Catalog.url}` : null;
          ...
          <div className="md:w-1/2 p-12 bg-white">
            <div className="space-y-10">
              ...
              <div className="flex gap-5">
                ...
                <div>
                    <p className="font-black uppercase text-[10px] text-zinc-400 mb-2 tracking-[0.15em]">Components</p>
                    <p className="text-zinc-700 leading-relaxed font-medium text-[14px] whitespace-pre-line italic">
                        {String(system.Components || "Technical data pending...")}
                    </p>
                </div>
              </div>
              ...
              <div className="flex gap-5">
                ...
                <div>
                    ...
                    <p className="text-zinc-700 font-semibold text-[14px]">
                        {String(system.Applications || "Commercial & Residential Use")}
                    </p>
                </div>
              </div>
              ...
              <div className="flex gap-5">
                ...
                <div>
                    <p className="font-black uppercase text-[10px] text-zinc-400 mb-2 tracking-[0.15em]">Warranty</p>
                    <p className="text-zinc-700 font-semibold text-[14px]">
                        {String(system.Warranty || "Not Specified")}
                    </p>
                </div>
              </div>
              ...
              <div className="flex gap-5">
                ...
                <div>
                    <p className="font-black uppercase text-[10px] text-zinc-400 mb-2 tracking-[0.15em]">Mounting options</p>
                    <p className="text-zinc-700 font-medium text-[13px]">
                        {String(system.Mounting || "Roof mounting kits & Flat mounting kits")}
                    </p>
                </div>
              </div>
              ...
              <div className="flex gap-5">
                ...
                <div>
                    <p className="font-black uppercase text-[10px] text-zinc-400 mb-2 tracking-[0.15em]">Safety & Certification</p>
                    <p className="text-zinc-700 font-medium text-[13px]">
                        {String(system.Certification || "International standards certification")}
                    </p>
                </div>
              </div>
